      ...
      <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-md-block>
              <p class="fadeInUp wow" data-wow-delay=".6s">Know about the Sessions</p>
        ...
        <div class="row">
          <div class="col-12">
            <div class="section-title-header text-center">
              ...
              <p class="wow fadeInDown" data-wow-delay="0.2s">Trends & Techniques in Today's Literature</p>
            </div>
          </div>
        </div>
        <div class="row">
    ...
    <section id="sponsors" class="section-padding">
      <div class="container">
        ...
        <div class="row mb-30 text-center wow fadeInDown" data-wow-delay="0.3s">
          <div class="sponsors"><p style="text-align:center; font-size:6">Comming Soon!</p>
          <!--
